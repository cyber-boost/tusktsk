...
This guide provides everything you need to use Peanut Configuration effectively with Go. For more information, refer to the [TuskLang documentation](https://tusklang.org) or the [Go SDK repository](https://github.com/tusklang/go-sdk). 