...
namespace TuskLang.Operators.Cloud
{
    ...
    public class AwsOperator : BaseOperator
    {
        ...
        public AwsOperator()
        {
            ...
            RequiredFields = new List<string> { "access_key", "secret_key", "region" };
        ...
        public override async Task<object> ExecuteAsync(Dictionary<string, object> config, Dictionary<string, object> context)
        {
            try
            {
                Log("info", $"Executing AWS operator with config: {JsonSerializer.Serialize(config)}");
        ...
        private async Task<object> ConnectAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"AWS connection failed: {ex.Message}", ex);
            }
        }
        ...
        private async Task<object> DisconnectAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"AWS disconnect failed: {ex.Message}", ex);
            }
        }
        ...
        private async Task<object> Ec2ListInstancesAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"EC2 list instances failed: {ex.Message}", "EC2_LIST_INSTANCES_ERROR", ex);
            }
        }
        ...
        private async Task<object> Ec2StartInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"EC2 start instance failed: {ex.Message}", "EC2_START_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> Ec2StopInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"EC2 stop instance failed: {ex.Message}", "EC2_STOP_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> Ec2TerminateInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"EC2 terminate instance failed: {ex.Message}", "EC2_TERMINATE_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> Ec2CreateInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"EC2 create instance failed: {ex.Message}", "EC2_CREATE_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> Ec2GetInstanceInfoAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"EC2 get instance info failed: {ex.Message}", "EC2_GET_INSTANCE_INFO_ERROR", ex);
            }
        }
        ...
        private async Task<object> S3ListBucketsAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"S3 list buckets failed: {ex.Message}", "S3_LIST_BUCKETS_ERROR", ex);
            }
        }
        ...
        private async Task<object> S3CreateBucketAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"S3 create bucket failed: {ex.Message}", "S3_CREATE_BUCKET_ERROR", ex);
            }
        }
        ...
        private async Task<object> S3DeleteBucketAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"S3 delete bucket failed: {ex.Message}", "S3_DELETE_BUCKET_ERROR", ex);
            }
        }
        ...
        private async Task<object> S3ListObjectsAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"S3 list objects failed: {ex.Message}", "S3_LIST_OBJECTS_ERROR", ex);
            }
        }
        ...
        private async Task<object> S3UploadFileAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"S3 upload file failed: {ex.Message}", "S3_UPLOAD_FILE_ERROR", ex);
            }
        }
        ...
        private async Task<object> S3DownloadFileAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"S3 download file failed: {ex.Message}", "S3_DOWNLOAD_FILE_ERROR", ex);
            }
        }
        ...
        private async Task<object> S3DeleteObjectAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"S3 delete object failed: {ex.Message}", "S3_DELETE_OBJECT_ERROR", ex);
            }
        }
        ...
        private async Task<object> LambdaListFunctionsAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"Lambda list functions failed: {ex.Message}", "LAMBDA_LIST_FUNCTIONS_ERROR", ex);
            }
        }
        ...
        private async Task<object> LambdaInvokeAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"Lambda invoke failed: {ex.Message}", "LAMBDA_INVOKE_ERROR", ex);
            }
        }
        ...
        private async Task<object> LambdaCreateFunctionAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"Lambda create function failed: {ex.Message}", "LAMBDA_CREATE_FUNCTION_ERROR", ex);
            }
        }
        ...
        private async Task<object> LambdaDeleteFunctionAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"Lambda delete function failed: {ex.Message}", "LAMBDA_DELETE_FUNCTION_ERROR", ex);
            }
        }
        ...
        private async Task<object> RdsListInstancesAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"RDS list instances failed: {ex.Message}", "RDS_LIST_INSTANCES_ERROR", ex);
            }
        }
        ...
        private async Task<object> RdsCreateInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"RDS create instance failed: {ex.Message}", "RDS_CREATE_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> RdsDeleteInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"RDS delete instance failed: {ex.Message}", "RDS_DELETE_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> CloudWatchGetMetricsAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"CloudWatch get metrics failed: {ex.Message}", "CLOUDWATCH_GET_METRICS_ERROR", ex);
            }
        }
        ...
        private async Task<object> CloudWatchPutMetricAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"CloudWatch put metric failed: {ex.Message}", "CLOUDWATCH_PUT_METRIC_ERROR", ex);
            }
        }
        ...
        private async Task<object> IamListUsersAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"IAM list users failed: {ex.Message}", "IAM_LIST_USERS_ERROR", ex);
            }
        }
        ...
        private async Task<object> IamCreateUserAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"IAM create user failed: {ex.Message}", "IAM_CREATE_USER_ERROR", ex);
            }
        }
        ...
        private async Task<object> IamDeleteUserAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"IAM delete user failed: {ex.Message}", "IAM_DELETE_USER_ERROR", ex);
            }
        }
        ...
        private async Task<object> TestConnectionAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception($"AWS connection test failed: {ex.Message}", ex);
            }
        }
        ...
        private void EnsureConnected()
        {
            ...
            {
                throw new Exception("Not connected to AWS");
            }
        }
