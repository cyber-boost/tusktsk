...
namespace TuskLang.Operators.Cloud
{
    ...
    /// Provides GCP operations including Compute Engine, Cloud Storage, Cloud Functions, and other GCP services
    /// </summary>
    public class GcpOperator : BaseOperator
    {
        ...
        public GcpOperator() : base("gcp", "Google Cloud Platform operations")
        {
            RegisterMethods();
        }
        ...
        {
            RegisterMethod("connect", "Connect to GCP", new[] { "project_id", "credentials" });
            RegisterMethod("disconnect", "Disconnect from GCP", new string[0]);
            RegisterMethod("compute_list_instances", "List Compute Engine instances", new string[0]);
            RegisterMethod("compute_start_instance", "Start Compute Engine instance", new[] { "zone", "instance_name" });
            RegisterMethod("compute_stop_instance", "Stop Compute Engine instance", new[] { "zone", "instance_name" });
            RegisterMethod("compute_delete_instance", "Delete Compute Engine instance", new[] { "zone", "instance_name" });
            RegisterMethod("compute_create_instance", "Create Compute Engine instance", new[] { "zone", "instance_name", "machine_type", "image" });
            RegisterMethod("compute_get_instance_info", "Get Compute Engine instance info", new[] { "zone", "instance_name" });
            RegisterMethod("storage_list_buckets", "List Cloud Storage buckets", new string[0]);
            RegisterMethod("storage_create_bucket", "Create Cloud Storage bucket", new[] { "bucket_name", "location" });
            RegisterMethod("storage_delete_bucket", "Delete Cloud Storage bucket", new[] { "bucket_name" });
            RegisterMethod("storage_list_objects", "List Cloud Storage objects", new[] { "bucket_name", "prefix" });
            RegisterMethod("storage_upload_file", "Upload file to Cloud Storage", new[] { "bucket_name", "object_name", "file_path" });
            RegisterMethod("storage_download_file", "Download file from Cloud Storage", new[] { "bucket_name", "object_name", "file_path" });
            RegisterMethod("storage_delete_object", "Delete Cloud Storage object", new[] { "bucket_name", "object_name" });
            RegisterMethod("functions_list", "List Cloud Functions", new string[0]);
            RegisterMethod("functions_invoke", "Invoke Cloud Function", new[] { "function_name", "payload" });
            RegisterMethod("functions_deploy", "Deploy Cloud Function", new[] { "function_name", "runtime", "source" });
            RegisterMethod("functions_delete", "Delete Cloud Function", new[] { "function_name" });
            RegisterMethod("sql_list_instances", "List Cloud SQL instances", new string[0]);
            RegisterMethod("sql_create_instance", "Create Cloud SQL instance", new[] { "instance_name", "database_version", "tier" });
            RegisterMethod("sql_delete_instance", "Delete Cloud SQL instance", new[] { "instance_name" });
            RegisterMethod("monitoring_get_metrics", "Get Cloud Monitoring metrics", new[] { "metric_type", "filter" });
            RegisterMethod("monitoring_write_metric", "Write Cloud Monitoring metric", new[] { "metric_type", "value", "labels" });
            RegisterMethod("logging_list_logs", "List Cloud Logging logs", new[] { "filter" });
            RegisterMethod("logging_write_log", "Write Cloud Logging log", new[] { "log_name", "severity", "message" });
            RegisterMethod("test_connection", "Test GCP connection", new string[0]);
        }
        ...
        public override async Task<object> ExecuteAsync(string method, Dictionary<string, object> parameters, Dictionary<string, object> context)
        {
            try
            {
                LogDebug($"Executing GCP operator method: {method}");
                ...
                switch (method.ToLower())
                {
                    ...
                    case "storage_upload_file":
                        return await StorageUploadFileAsync(parameters);
                    case "storage_download_file":
                        return await StorageDownloadFileAsync(parameters);
                    ...
                    case "functions_deploy":
                        return await FunctionsDeployAsync(parameters);
                    ...
                    case "monitoring_write_metric":
                        return await MonitoringWriteMetricAsync(parameters);
                    case "logging_list_logs":
                        return await LoggingListLogsAsync(parameters);
                    case "logging_write_log":
                        return await LoggingWriteLogAsync(parameters);
                    case "test_connection":
                        return await TestConnectionAsync();
                    default:
                        throw new ArgumentException($"Unknown GCP method: {method}", nameof(method));
                }
            }
            catch (Exception ex)
            {
                LogError($"Error executing GCP method {method}: {ex.Message}");
                throw new OperatorException($"GCP operation failed: {ex.Message}", "GCP_ERROR", ex);
            }
        }
        ...
        private async Task<object> ConnectAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP connection failed: {ex.Message}", "GCP_CONNECTION_ERROR", ex);
            }
        }
        ...
        private async Task<object> DisconnectAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP disconnect failed: {ex.Message}", "GCP_DISCONNECT_ERROR", ex);
            }
        }
        ...
        private async Task<object> ComputeListInstancesAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Compute list instances failed: {ex.Message}", "GCP_COMPUTE_LIST_INSTANCES_ERROR", ex);
            }
        }
        ...
        private async Task<object> ComputeStartInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Compute start instance failed: {ex.Message}", "GCP_COMPUTE_START_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> ComputeStopInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Compute stop instance failed: {ex.Message}", "GCP_COMPUTE_STOP_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> ComputeDeleteInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Compute delete instance failed: {ex.Message}", "GCP_COMPUTE_DELETE_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> ComputeCreateInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Compute create instance failed: {ex.Message}", "GCP_COMPUTE_CREATE_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> ComputeGetInstanceInfoAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Compute get instance info failed: {ex.Message}", "GCP_COMPUTE_GET_INSTANCE_INFO_ERROR", ex);
            }
        }
        ...
        private async Task<object> StorageListBucketsAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Storage list buckets failed: {ex.Message}", "GCP_STORAGE_LIST_BUCKETS_ERROR", ex);
            }
        }
        ...
        private async Task<object> StorageCreateBucketAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Storage create bucket failed: {ex.Message}", "GCP_STORAGE_CREATE_BUCKET_ERROR", ex);
            }
        }
        ...
        private async Task<object> StorageDeleteBucketAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Storage delete bucket failed: {ex.Message}", "GCP_STORAGE_DELETE_BUCKET_ERROR", ex);
            }
        }
        ...
        private async Task<object> StorageListObjectsAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Storage list objects failed: {ex.Message}", "GCP_STORAGE_LIST_OBJECTS_ERROR", ex);
            }
        }

        private async Task<object> StorageUploadFileAsync(Dictionary<string, object> parameters)
        {
            EnsureConnected();
            var bucketName = GetRequiredParameter<string>(parameters, "bucket_name");
            ...
            try
            {
                ...
                return new { success = true, bucketName, objectName, filePath, object = resultObj };
            }
            catch (Exception ex)
            {
                LogError($"Error uploading file to GCP Cloud Storage: {ex.Message}");
                throw new OperatorException($"GCP Storage upload file failed: {ex.Message}", "GCP_STORAGE_UPLOAD_FILE_ERROR", ex);
            }
        }

        private async Task<object> StorageDownloadFileAsync(Dictionary<string, object> parameters)
        {
            EnsureConnected();
            var bucketName = GetRequiredParameter<string>(parameters, "bucket_name");
            var objectName = GetRequiredParameter<string>(parameters, "object_name");
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Storage download file failed: {ex.Message}", "GCP_STORAGE_DOWNLOAD_FILE_ERROR", ex);
            }
        }
        ...
        private async Task<object> StorageDeleteObjectAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Storage delete object failed: {ex.Message}", "GCP_STORAGE_DELETE_OBJECT_ERROR", ex);
            }
        }
        ...
        private async Task<object> FunctionsListAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Functions list failed: {ex.Message}", "GCP_FUNCTIONS_LIST_ERROR", ex);
            }
        }
        ...
        private async Task<object> FunctionsInvokeAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Functions invoke failed: {ex.Message}", "GCP_FUNCTIONS_INVOKE_ERROR", ex);
            }
        }

        private async Task<object> FunctionsDeployAsync(Dictionary<string, object> parameters)
        {
            EnsureConnected();
            var functionName = GetRequiredParameter<string>(parameters, "function_name");
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Functions deploy failed: {ex.Message}", "GCP_FUNCTIONS_DEPLOY_ERROR", ex);
            }
        }
        ...
        private async Task<object> FunctionsDeleteAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Functions delete failed: {ex.Message}", "GCP_FUNCTIONS_DELETE_ERROR", ex);
            }
        }
        ...
        private async Task<object> SqlListInstancesAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP SQL list instances failed: {ex.Message}", "GCP_SQL_LIST_INSTANCES_ERROR", ex);
            }
        }
        ...
        private async Task<object> SqlCreateInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP SQL create instance failed: {ex.Message}", "GCP_SQL_CREATE_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> SqlDeleteInstanceAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP SQL delete instance failed: {ex.Message}", "GCP_SQL_DELETE_INSTANCE_ERROR", ex);
            }
        }
        ...
        private async Task<object> MonitoringGetMetricsAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Monitoring get metrics failed: {ex.Message}", "GCP_MONITORING_GET_METRICS_ERROR", ex);
            }
        }

        private async Task<object> MonitoringWriteMetricAsync(Dictionary<string, object> parameters)
        {
            EnsureConnected();
            var metricType = GetRequiredParameter<string>(parameters, "metric_type");
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Monitoring write metric failed: {ex.Message}", "GCP_MONITORING_WRITE_METRIC_ERROR", ex);
            }
        }
        ...
        private async Task<object> LoggingListLogsAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Logging list logs failed: {ex.Message}", "GCP_LOGGING_LIST_LOGS_ERROR", ex);
            }
        }
        ...
        private async Task<object> LoggingWriteLogAsync(Dictionary<string, object> parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP Logging write log failed: {ex.Message}", "GCP_LOGGING_WRITE_LOG_ERROR", ex);
            }
        }
        ...
        private async Task<object> TestConnectionAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP connection test failed: {ex.Message}", "GCP_CONNECTION_TEST_ERROR", ex);
            }
        }
        ...
        private async Task<string> GetAccessTokenAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new OperatorException($"GCP access token failed: {ex.Message}", "GCP_ACCESS_TOKEN_ERROR", ex);
            }
        }
        ...
        private void EnsureConnected()
        {
            ...
            {
                throw new OperatorException("Not connected to GCP", "GCP_NOT_CONNECTED");
            }
        }
