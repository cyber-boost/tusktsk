...
namespace TuskLang.Parser
{
    ...
    public class TuskTskParser : IDisposable
    {
        ...
        private IncludeNode ParseInclude()
        {
            ...
            return new IncludeNode(pathExpression, isImport, keywordToken.Line);
        }
        ...
        private ExpressionNode ParseLogicalOr()
        {
            ...
            while (Match(TokenType.OrOr, TokenType.LogicalOr))
            {
                ...
                expr = new BinaryOperatorNode(expr, operatorToken.Type.ToString(), right, operatorToken.Line);
            }
        ...
        private ExpressionNode ParsePostfix()
        {
            ...
            while (true)
            {
                ...
                else if (Match(TokenType.LeftParen))
                {
                    ...
                    expr = new MethodCallNode(expr, args, Previous.Line);
                }
        ...
        private AtOperatorNode ParseEnvOperator()
        {
            ...
            return new AtOperatorNode("env", args, Previous.Line);
        }
        ...
        private AtOperatorNode ParseQueryOperator()
        {
            ...
            return new AtOperatorNode("query", new[] { queryString }, Previous.Line);
        }
        ...
        private AtOperatorNode ParseDateOperator()
        {
            ...
            return new AtOperatorNode("date", new[] { formatString }, Previous.Line);
        }
        ...
        private AtOperatorNode ParseSimpleAtOperator(string operatorName)
        {
            ...
            return new AtOperatorNode(operatorName, args, Previous.Line);
        }
        ...
        private AtOperatorNode ParseCrossFileOrGenericOperator(string operatorName)
        {
            ...
            if (Match(TokenType.Dot) && Check(TokenType.Identifier))
            {
                ...
                if (fileExtension == "tsk" && Match(TokenType.Dot) && Check(TokenType.Identifier))
                {
                    ...
                    return new CrossFileOperatorNode(operatorName, methodName, args, Previous.Line);
                }
            }
            ...
            return new AtOperatorNode(operatorName, Array.Empty<ExpressionNode>(), Previous.Line);
        }
        ...
        private ArrayNode ParseArray()
        {
            ...
            return new ArrayNode(elements, Previous.Line);
        }
        ...
        private ObjectNode ParseObject()
        {
            ...
            return new ObjectNode(properties, Previous.Line);
        }
        
        /// <summary>
        /// Parse object with angle brackets: identifier > key: value &lt;
        /// </summary>
        private ObjectNode ParseAngleObject()
        {
            ...
            return new NamedObjectNode(objectName, properties, nameToken.Line);
        }
