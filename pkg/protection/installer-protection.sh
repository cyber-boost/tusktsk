...
# Configuration
VERSION="2.0.0"
LICENSE_SERVER="https://license.tusklang.org/api/v1"
DOWNLOAD_BASE="https://downloads.tusklang.org"
PUBLIC_KEY_URL="https://tusklang.org/keys/tusklang-public.asc"
...
main() {
    ...
    echo "2. Visit https://docs.tusklang.org for documentation"
    echo "3. Join our community at https://github.com/tuskphp/tusklang"
}
